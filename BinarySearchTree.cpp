	...
	//                                  Which Uses Root Ptr 
        ...
        template <class Comparable>
        void BinarySearchTree<Comparable>::printTree( ofstream& outfile ) const
        {
            if( isEmpty( ) )
        ...
        template <class Comparable>
        void BinarySearchTree<Comparable>::printTree( ofstream& outfile, BinaryNode<Comparable> *t ) const
        {
            if( t != NULL )
            {
                printTree( outfile, t->left );
                outfile << t->element.word << " " << t->element.lineNum << endl;
                printTree( outfile, t->right );
            }
        }
